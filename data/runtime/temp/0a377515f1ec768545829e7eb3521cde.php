<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"themes/admin_simpleboot3/portal\admin_article\edit.html";i:1516676889;s:77:"C:\wwwroot\htdocs\thinkcmf\public\themes\admin_simpleboot3\public\header.html";i:1516676889;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
                            ...
                            <ul id="files" class="pic-list list-unstyled form-inline">
                                <?php if(!(empty($post['more']['files']) || (($post['more']['files'] instanceof \think\Collection || $post['more']['files'] instanceof \think\Paginator ) && $post['more']['files']->isEmpty()))): if(is_array($post['more']['files']) || $post['more']['files'] instanceof \think\Collection || $post['more']['files'] instanceof \think\Paginator): if( count($post['more']['files'])==0 ) : echo "" ;else: foreach($post['more']['files'] as $key=>$vo): $file_url=cmf_get_file_download_url($vo['url']); ?>
                                        <li id="saved-file<?php echo $key; ?>">
                                            ...
                                            <a href="javascript:uploadOne('图片上传','#file-<?php echo $key; ?>','file');">替换</a>
...
<script type="text/javascript">
    $(function () {
        ...
        $('.btn-cancel-thumbnail').click(function () {
            $('#thumbnail-preview').attr('src', '/thinkcmf/public/themes/admin_simpleboot3/public/assets/images/default-thumbnail.png');
            $('#thumbnail').val('');
        });
