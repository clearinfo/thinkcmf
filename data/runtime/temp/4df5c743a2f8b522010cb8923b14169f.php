<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:37:"themes/simpleboot3/portal\\index.html";i:1516676889;s:63:"E:\wamp\www\thinkcmf\public\themes\simpleboot3\public\head.html";i:1523762513;s:67:"E:\wamp\www\thinkcmf\public\themes\simpleboot3\public\function.html";i:1516676889;s:62:"E:\wamp\www\thinkcmf\public\themes\simpleboot3\public\nav.html";i:1516676889;s:65:"E:\wamp\www\thinkcmf\public\themes\simpleboot3\public\footer.html";i:1516676889;s:66:"E:\wamp\www\thinkcmf\public\themes\simpleboot3\public\scripts.html";i:1516676889;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script src="/thinkcmf/public/static/js/wind.js"></script>
    ...
    <link href="/thinkcmf/public/themes/simpleboot3/public/assets/css/slippry/slippry.css" rel="stylesheet">
    <style>
        .caption-wraper {
            position: absolute;
            left: 50%;
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp5ad9742946836,null,false);
 ?>
</head>
...
function __parse_navigationf78030d7e7044ccdb35e4f122e11654b($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigationf78030d7e7044ccdb35e4f122e11654b';
...
if(''==''): ?>
    <?php echo __parse_navigationf78030d7e7044ccdb35e4f122e11654b($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigationf78030d7e7044ccdb35e4f122e11654b($menus); ?>
    </>
<?php endif; ?>
...
if(count($__SLIDE_ITEMS__) == 0): ?>
        ...
        <li>
            ...
            <a href=""><img src="/thinkcmf/public/themes/simpleboot3/public/assets/images/demo/1.jpg" alt=""></a>
        </li>
        <li>
            <div class="caption-wraper">
                <div class="caption">此幻灯片只是演示,您没有设置任何幻灯片,请到后台模板设置！</div>
            </div>
            <a href=""><img src="/thinkcmf/public/themes/simpleboot3/public/assets/images/demo/2.jpg" alt=""></a>
        </li>
        <li>
            <div class="caption-wraper">
                <div class="caption">此幻灯片只是演示,您没有设置任何幻灯片,请到后台模板设置！</div>
            </div>
            <a href=""><img src="/thinkcmf/public/themes/simpleboot3/public/assets/images/demo/3.jpg" alt=""></a>
        </li>
...
<div class="container">
 ...
 ?>
        ...
        <?php 
         ...
         $__FOR_START_14990__=1;$__FOR_END_14990__=$rows;for($row=$__FOR_START_14990__;$row <= $__FOR_END_14990__;$row+=1){ 
                $first_row = ($row-1)*3;
                            ...
                            <div class="item-image">
                                <a href="<?php echo cmf_url('portal/Article/index',array('id'=>$vo['id'],'cid'=>$vo['category_id'])); ?>">
                                    <?php if(isset($vo['more']['thumbnail'])): if(empty($vo['more']['thumbnail']) || (($vo['more']['thumbnail'] instanceof \think\Collection || $vo['more']['thumbnail'] instanceof \think\Paginator ) && $vo['more']['thumbnail']->isEmpty())): ?>
                                            <img src="/thinkcmf/public/themes/simpleboot3/public/assets/images/default-thumbnail.png"
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5ad9742946836,null,false);
 ?>
    <div class="links">
        <?php
...
<script src="/thinkcmf/public/themes/simpleboot3/public/assets/js/slippry.min.js"></script>
<script>
    $(function () {
        $("#home-slider").slippry({
            transition: 'fade',
...
<?php 
    \think\Hook::listen('before_body_end',$temp5ad9742946836,null,false);
 ?>
</body>
</html>
