<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:58:"themes/admin_simpleboot3/admin\theme\file_var_setting.html";i:1516676889;s:85:"C:\wwwroot\htdocs\thinkcmf\public\themes\admin_simpleboot3\admin\theme\functions.html";i:1516676889;s:77:"C:\wwwroot\htdocs\thinkcmf\public\themes\admin_simpleboot3\public\header.html";i:1516676889;s:83:"C:\wwwroot\htdocs\thinkcmf\public\themes\admin_simpleboot3\admin\theme\scripts.html";i:1516676889;}*/ ?>
<?php 
...
<div class="wrap">
    ...
    <form method="post" class="js-ajax-form  margin-top-20" action="<?php echo url('theme/settingPost'); ?>">
        <?php if(!(empty($file['more']['vars']) || (($file['more']['vars'] instanceof \think\Collection || $file['more']['vars'] instanceof \think\Paginator ) && $file['more']['vars']->isEmpty()))): ?>
            <?php echo _parse_vars($file['more']['vars'],'vars'); else: ?>
            <div>本页面没有设置任何变量</div>
        <?php endif; ?>
