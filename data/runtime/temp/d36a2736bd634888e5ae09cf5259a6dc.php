...
function __parse_navigation04b1005abc795177bae578124f664ff9($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation04b1005abc795177bae578124f664ff9';
...
if(''==''): ?>
    <?php echo __parse_navigation04b1005abc795177bae578124f664ff9($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation04b1005abc795177bae578124f664ff9($menus); ?>
    </>
<?php endif; ?>
						...
						<div class="tab-pane active" id="one">
							...
							<div class="row">
								...
								<a href="<?php echo url('profile/avatar'); ?>">
									<?php if(empty($avatar)): ?> 
										<img src="/thinkcmf/public/themes/simpleboot3/public/assets/images/headicon_128.png" class="headicon" width="128" />
									<?php else: ?>
										<img src="/thinkcmf/public/upload/<?php echo $avatar; ?>" class="headicon" width="128"/>
									<?php endif; ?>
								</a>
							</div>
							<div class="col-md-9">
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5ad2a2f85e3fe,null,false);
 ?>
    <div class="links">
        <?php
