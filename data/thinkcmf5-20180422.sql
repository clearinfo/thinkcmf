...
INSERT INTO `cmf_admin_menu` VALUES ('162', '1', '1', '1', '10000', 'plugin/Wxapp', 'AdminIndex', 'index', '', '小程序管理', '', '小程序管理');
INSERT INTO `cmf_admin_menu` VALUES ('163', '162', '1', '0', '10000', 'plugin/Wxapp', 'AdminWxapp', 'add', '', '添加小程序', '', '添加小程序');
INSERT INTO `cmf_admin_menu` VALUES ('164', '162', '2', '0', '10000', 'plugin/Wxapp', 'AdminWxapp', 'addPost', '', '添加小程序提交保存', '', '添加小程序提交保存');
INSERT INTO `cmf_admin_menu` VALUES ('165', '162', '1', '0', '10000', 'plugin/Wxapp', 'AdminWxapp', 'edit', '', '编辑小程序', '', '编辑小程序');
INSERT INTO `cmf_admin_menu` VALUES ('166', '162', '2', '0', '10000', 'plugin/Wxapp', 'AdminWxapp', 'editPost', '', '编辑小程序提交保存', '', '编辑小程序');
INSERT INTO `cmf_admin_menu` VALUES ('167', '162', '2', '0', '10000', 'plugin/Wxapp', 'AdminWxapp', 'delete', '', '删除小程序', '', '删除小程序');
INSERT INTO `cmf_admin_menu` VALUES ('168', '1', '1', '1', '10000', 'plugin/Demo', 'AdminIndex', 'index', '', '演示插件', '', '演示插件');
INSERT INTO `cmf_admin_menu` VALUES ('169', '168', '1', '0', '10000', 'plugin/Demo', 'AdminIndex', 'setting', '', '演示插件设置', '', '演示插件设置');
INSERT INTO `cmf_admin_menu` VALUES ('176', '1', '1', '1', '10000', 'plugin/React', 'AdminIndex', 'index', '', 'React创建工具', '', 'React创建工具');
INSERT INTO `cmf_admin_menu` VALUES ('177', '176', '1', '0', '10000', 'plugin/React', 'AdminIndex', 'setting', '', '演示插件设置', '', '演示插件设置');
...
INSERT INTO `cmf_auth_rule` VALUES ('162', '1', 'plugin/Wxapp', 'plugin_url', 'plugin/Wxapp/AdminIndex/index', '', '小程序管理', '');
INSERT INTO `cmf_auth_rule` VALUES ('163', '1', 'plugin/Wxapp', 'plugin_url', 'plugin/Wxapp/AdminWxapp/add', '', '添加小程序', '');
INSERT INTO `cmf_auth_rule` VALUES ('164', '1', 'plugin/Wxapp', 'plugin_url', 'plugin/Wxapp/AdminWxapp/addPost', '', '添加小程序提交保存', '');
INSERT INTO `cmf_auth_rule` VALUES ('165', '1', 'plugin/Wxapp', 'plugin_url', 'plugin/Wxapp/AdminWxapp/edit', '', '编辑小程序', '');
INSERT INTO `cmf_auth_rule` VALUES ('166', '1', 'plugin/Wxapp', 'plugin_url', 'plugin/Wxapp/AdminWxapp/editPost', '', '编辑小程序提交保存', '');
INSERT INTO `cmf_auth_rule` VALUES ('167', '1', 'plugin/Wxapp', 'plugin_url', 'plugin/Wxapp/AdminWxapp/delete', '', '删除小程序', '');
INSERT INTO `cmf_auth_rule` VALUES ('168', '1', 'plugin/Demo', 'plugin_url', 'plugin/Demo/AdminIndex/index', '', '演示插件', '');
INSERT INTO `cmf_auth_rule` VALUES ('169', '1', 'plugin/Demo', 'plugin_url', 'plugin/Demo/AdminIndex/setting', '', '演示插件设置', '');
INSERT INTO `cmf_auth_rule` VALUES ('176', '1', 'plugin/React', 'plugin_url', 'plugin/React/AdminIndex/index', '', 'React创建工具', '');
INSERT INTO `cmf_auth_rule` VALUES ('177', '1', 'plugin/React', 'plugin_url', 'plugin/React/AdminIndex/setting', '', '演示插件设置', '');
...
CREATE TABLE `cmf_hook_plugin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COMMENT='系统钩子插件表';

-- ----------------------------
-- Records of cmf_hook_plugin
-- ----------------------------
INSERT INTO `cmf_hook_plugin` VALUES ('1', '10000', '1', 'admin_dashboard', 'SystemInfo');
INSERT INTO `cmf_hook_plugin` VALUES ('2', '10000', '1', 'footer_start', 'Demo');
INSERT INTO `cmf_hook_plugin` VALUES ('6', '10000', '1', 'footer_start', 'React');
INSERT INTO `cmf_hook_plugin` VALUES ('7', '10000', '1', 'send_mobile_verification_code', 'MobileCodeDemo');
...
-- ----------------------------
INSERT INTO `cmf_option` VALUES ('1', '1', 'site_info', '{\"site_name\":\"ReactVue\\u5185\\u5bb9\\u7ba1\\u7406\",\"site_seo_title\":\"ReactVue\\u5185\\u5bb9\\u7ba1\\u7406\",\"site_seo_keywords\":\"react,vue,php,\\u5185\\u5bb9\\u7ba1\\u7406\\u6846\\u67b6,cmf,cms,\\u7b80\\u7ea6\\u98ce, simplewind,framework\",\"site_seo_description\":\"\\u4e3a\\u4e86\\u5feb\\u901f\\u3001\\u65b9\\u4fbf\\u3001\\u9ad8\\u6548\\u521b\\u5efa\\u524d\\u7aef\\u7801\"}');
INSERT INTO `cmf_option` VALUES ('2', '1', 'wxapp_settings', '{\"wxapps\":{\"222222\":{\"name\":\"\\u4e91\\u6613\\u529e\\u516c\",\"app_id\":\"222222\",\"app_secret\":\"6666666\",\"_plugin\":\"wxapp\",\"_controller\":\"admin_wxapp\",\"_action\":\"editpost\"}}}');
...
INSERT INTO `cmf_plugin` VALUES ('2', '1', '0', '1', '0', 'SystemInfo', '系统信息', '', '', 'ThinkCMF', '', '1.0', '系统信息', '[]');
INSERT INTO `cmf_plugin` VALUES ('3', '1', '1', '1', '0', 'Demo', '插件演示', 'http://demo.thinkcmf.com', '', 'ThinkCMF', 'http://www.thinkcmf.com', '1.0', '插件演示', '{\"custom_config\":\"0\",\"text\":\"hello,ThinkCMF!\",\"password\":\"\",\"number\":\"1.0\",\"select\":\"1\",\"checkbox\":1,\"radio\":\"1\",\"radio2\":\"1\",\"textarea\":\"\\u8fd9\\u91cc\\u662f\\u4f60\\u8981\\u586b\\u5199\\u7684\\u5185\\u5bb9\",\"date\":\"2017-05-20\",\"datetime\":\"2017-05-20\",\"color\":\"#103633\",\"image\":\"\",\"file\":\"\",\"location\":\"\"}');
INSERT INTO `cmf_plugin` VALUES ('7', '1', '1', '1', '0', 'React', 'React创建工具', 'http://demo.thinkcmf.com', '', 'songxian', 'http://www.thinkcmf.com', '1.0', 'React创建工具', '{\"custom_config\":\"0\",\"text\":\"hello,ThinkCMF!\",\"password\":\"\",\"number\":\"1.0\",\"select\":\"1\",\"checkbox\":1,\"radio\":\"1\",\"radio2\":\"1\",\"textarea\":\"\\u8fd9\\u91cc\\u662f\\u4f60\\u8981\\u586b\\u5199\\u7684\\u5185\\u5bb9\",\"date\":\"2017-05-20\",\"datetime\":\"2017-05-20\",\"color\":\"#103633\",\"image\":\"\",\"file\":\"\",\"location\":\"\"}');
INSERT INTO `cmf_plugin` VALUES ('8', '1', '0', '1', '0', 'MobileCodeDemo', '手机验证码演示插件', '', '', 'ThinkCMF', '', '1.0', '手机验证码演示插件', '{\"account_sid\":\"\",\"auth_token\":\"\",\"app_id\":\"\",\"template_id\":\"\",\"expire_minute\":\"30\"}');
...
-- ----------------------------
INSERT INTO `cmf_portal_category` VALUES ('1', '0', '0', '1', '0', '10000', 'React', '', '0-1', '', '', '', 'list', 'article', '{\"thumbnail\":\"\"}');
...
-- ----------------------------
INSERT INTO `cmf_portal_post` VALUES ('1', '0', '1', '1', '1', '1', '1', '0', '0', '4', '0', '0', '1523684369', '1523684369', '1523684290', '0', 'Hello world', '', '', '', '\n&lt;pre class=&quot;brush:html;toolbar:false&quot;&gt;&amp;lt;vue v-model=&quot;message&quot;&amp;gt;&amp;lt;/vue&amp;gt;&lt;/pre&gt;\n&lt;p&gt;&lt;br&gt;&lt;/p&gt;\n', null, '{\"thumbnail\":\"\",\"template\":\"\"}');
...
-- ----------------------------
-- Table structure for cmf_reactdata
-- ----------------------------
DROP TABLE IF EXISTS `cmf_reactdata`;
CREATE TABLE `cmf_reactdata` (
...
-- ----------------------------
-- Records of cmf_reactdata
-- ----------------------------

-- ----------------------------
-- Table structure for cmf_reactfilelist
-- ----------------------------
DROP TABLE IF EXISTS `cmf_reactfilelist`;
CREATE TABLE `cmf_reactfilelist` (
  `id` int(255) NOT NULL AUTO_INCREMENT,
  `gid` int(255) DEFAULT NULL COMMENT '所属项目id',
  `filename` varchar(255) DEFAULT NULL COMMENT '文件名',
  `descoration` varchar(255) DEFAULT NULL COMMENT '栏目名称',
  `postfixname` varchar(255) NOT NULL COMMENT '文件后缀',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of cmf_reactfilelist
-- ----------------------------
INSERT INTO `cmf_reactfilelist` VALUES ('1', '35', 'adwords', '广告管理', '.vue');
INSERT INTO `cmf_reactfilelist` VALUES ('2', '56', 'notice', '公告管理', '.vue');
INSERT INTO `cmf_reactfilelist` VALUES ('3', '789', 'answers', '问题列表', '.vue');
INSERT INTO `cmf_reactfilelist` VALUES ('4', '3364', 'userlist', '用户列表', '.js');

-- ----------------------------
-- Table structure for cmf_reactform
-- ----------------------------
DROP TABLE IF EXISTS `cmf_reactform`;
CREATE TABLE `cmf_reactform` (
  `formid` int(255) NOT NULL AUTO_INCREMENT,
  `formclass` varchar(255) DEFAULT NULL COMMENT '数值类型',
  `formcontent` text COMMENT 'input内容',
  PRIMARY KEY (`formid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of cmf_reactform
-- ----------------------------
INSERT INTO `cmf_reactform` VALUES ('1', '1', '');

-- ----------------------------
-- Table structure for cmf_reactvue
-- ----------------------------
DROP TABLE IF EXISTS `cmf_reactvue`;
CREATE TABLE `cmf_reactvue` (
  `rid` int(255) NOT NULL AUTO_INCREMENT,
  `fileid` int(255) NOT NULL COMMENT '所属文件id',
  `name_en` varchar(255) DEFAULT NULL COMMENT '参数名',
  `name_zh` varchar(255) DEFAULT NULL COMMENT '中文注释',
  `formtype` int(255) NOT NULL COMMENT '表单类型',
  `valtype` int(255) NOT NULL COMMENT '数值类型',
  `values` text,
  `istable` int(255) NOT NULL DEFAULT '1' COMMENT '显示在表格',
  `width` int(255) DEFAULT NULL COMMENT '单元格宽度',
  PRIMARY KEY (`rid`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of cmf_reactvue
-- ----------------------------
INSERT INTO `cmf_reactvue` VALUES ('1', '2', 'title', '名称', '0', '0', '1', '0', '110');
INSERT INTO `cmf_reactvue` VALUES ('2', '2', 'descoration', '摘要', '0', '1', 'myname888', '0', '120');
INSERT INTO `cmf_reactvue` VALUES ('3', '2', 'wenhao', '文号', '2', '1', '1', '0', '150');
INSERT INTO `cmf_reactvue` VALUES ('4', '2', 'tuijian', '推荐', '2', '1', '1', '0', '180');
INSERT INTO `cmf_reactvue` VALUES ('5', '2', 'picurl', '图片', '1', '1', '1', '0', '200');
INSERT INTO `cmf_reactvue` VALUES ('6', '2', 'content', '内容', '0', '0', '666', '0', null);
INSERT INTO `cmf_reactvue` VALUES ('7', '3', 'myname', '我的名字', '1', '1', '1', '1', null);
INSERT INTO `cmf_reactvue` VALUES ('8', '3', 'mycityname', '所在城市', '2', '0', '1345', '1', '120');
INSERT INTO `cmf_reactvue` VALUES ('9', '0', 'attt', '附件', '0', '0', '123', '1', null);
INSERT INTO `cmf_reactvue` VALUES ('10', '0', 'yyyy', '测试名称', '0', '0', '1', '0', '145');
INSERT INTO `cmf_reactvue` VALUES ('11', '0', 'zz', '测试名称', '0', '0', '1', '0', '145');
INSERT INTO `cmf_reactvue` VALUES ('12', '0', 'xx', '测试名称', '0', '0', '1', '0', '145');
INSERT INTO `cmf_reactvue` VALUES ('13', '0', 'vvv', 'gfdg', '0', '0', '11', '1', '122');
INSERT INTO `cmf_reactvue` VALUES ('14', '0', 'bbb', 'gfdg', '0', '0', '11', '1', '122');
INSERT INTO `cmf_reactvue` VALUES ('15', '0', 'bbbvvvv', 'gfdg', '0', '0', '11', '1', '122');
INSERT INTO `cmf_reactvue` VALUES ('16', '0', 'bbbvvvv', 'gfdg', '0', '0', '11', '1', '122');
INSERT INTO `cmf_reactvue` VALUES ('17', '0', 'bbbvvvv', 'gfdg', '0', '0', '11', '1', '122');
INSERT INTO `cmf_reactvue` VALUES ('18', '0', 'bbbvvvv', 'gfdg', '0', '0', '11', '1', '122');
INSERT INTO `cmf_reactvue` VALUES ('19', '0', 'bbbvvvv', 'gfdg', '0', '0', '11', '1', '122');
INSERT INTO `cmf_reactvue` VALUES ('20', '0', 'rtrtutr', 'tutu', '0', '0', '', '1', '5658');
INSERT INTO `cmf_reactvue` VALUES ('21', '0', 'rtrtutr', 'tutu', '0', '0', '', '1', '5658');
INSERT INTO `cmf_reactvue` VALUES ('22', '0', 'rtrtutr', 'tutu', '0', '0', '', '1', '5658');
INSERT INTO `cmf_reactvue` VALUES ('23', '0', 'aa555', 'tutu', '0', '0', '', '1', '5658');
INSERT INTO `cmf_reactvue` VALUES ('24', '0', 'aaaa', 'tutu', '0', '0', '', '1', '5658');
INSERT INTO `cmf_reactvue` VALUES ('25', '0', 'aaaa', 'tutu', '0', '0', '', '1', '5658');
INSERT INTO `cmf_reactvue` VALUES ('26', '0', 'aaaa', 'tutu', '0', '0', '', '1', '5658');
INSERT INTO `cmf_reactvue` VALUES ('27', '2', 'dddd', 'eyreyre', '0', '0', '4', '4', '566');
INSERT INTO `cmf_reactvue` VALUES ('28', '2', 'color', '颜色', '0', '0', '1', '1', '120');
INSERT INTO `cmf_reactvue` VALUES ('29', '2', 'size', '大小', '0', '0', '2', '1', '120');
INSERT INTO `cmf_reactvue` VALUES ('30', '2', 'guanlian', '关联栏目', '0', '0', '1', '1', '130');
INSERT INTO `cmf_reactvue` VALUES ('31', '2', 'oldname', '旧时名称', '1', '0', '1', '0', '50');
INSERT INTO `cmf_reactvue` VALUES ('32', '2', 'address', '地址1', '0', '0', 'beijing', '1', '100');
INSERT INTO `cmf_reactvue` VALUES ('33', '2', 'english', '英文注解', '0', '0', '1', '1', '70');
...
-- ----------------------------
INSERT INTO `cmf_route` VALUES ('1', '5000', '1', '2', 'portal/List/index?id=1', 'react');
INSERT INTO `cmf_route` VALUES ('2', '4999', '1', '2', 'portal/Article/index?cid=1', 'react/:id');
...
INSERT INTO `cmf_theme_file` VALUES ('10', '0', '10', 'simpleboot3', 'React页', 'portal/React/index', 'portal/react', 'React页模板文件', '{\"vars\":{\"hot_articles_category_id\":{\"title\":\"Hot Articles\\u5206\\u7c7bID\",\"value\":\"2\",\"type\":\"text\",\"tip\":\"\",\"rule\":[]}}}', '{\"vars\":{\"hot_articles_category_id\":{\"title\":\"Hot Articles\\u5206\\u7c7bID\",\"value\":\"2\",\"type\":\"text\",\"tip\":\"\",\"rule\":[]}}}', null);
...
-- Records of cmf_user
-- ----------------------------
INSERT INTO `cmf_user` VALUES ('1', '1', '0', '0', '1524389462', '1', '1', '0.00', '1523683335', '1', 'admin', '###842861c912b7401e3fa518ca55a72566', 'admin', 'songxian@163.com', '', '', '', '0.0.0.0', '', '', null);
...
-- ----------------------------
INSERT INTO `cmf_user_score_log` VALUES ('1', '1', '1523753432', 'login', '1', '1');
...
-- ----------------------------
INSERT INTO `cmf_user_token` VALUES ('1', '1', '1539235566', '1523683566', '8fff61cf524a65e0ffaff9f8178fc21ece38ba9008f16b8a21a9c6b3895a3ab2', 'web');
