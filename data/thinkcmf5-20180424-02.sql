...
-- ----------------------------
-- Table structure for cmf_reactapp
-- ----------------------------
DROP TABLE IF EXISTS `cmf_reactapp`;
CREATE TABLE `cmf_reactapp` (
  `id` int(255) NOT NULL AUTO_INCREMENT,
  `classid` int(255) DEFAULT NULL COMMENT '项目ID',
  `fileid` int(255) DEFAULT NULL COMMENT '所在页面',
  `name_en` varchar(255) DEFAULT NULL,
  `name_zh` varchar(255) DEFAULT NULL,
  `pubattr` varchar(255) DEFAULT NULL COMMENT '公共参数',
  `prvattr` varchar(255) DEFAULT NULL COMMENT '私有参数',
  `attrid` varchar(255) DEFAULT NULL COMMENT '传值id',
  `apiurl` varchar(255) DEFAULT NULL,
  `loadfun` int(255) DEFAULT NULL COMMENT '是否预加载',
  `values` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of cmf_reactapp
-- ----------------------------
INSERT INTO `cmf_reactapp` VALUES ('1', '1', '2', 'add', '添加', 'token', 'admin', 'uid', 'http://www.baidu.com', '0', null);
INSERT INTO `cmf_reactapp` VALUES ('4', '1', '2', 'edit', '修改', 'admin,token', 'uid,uname', 'rid', 'http://www.name.com', '0', null);
INSERT INTO `cmf_reactapp` VALUES ('5', '1', '2', 'remove', '删除', 'aa:123,bb:456', 'username:song,token:w232r3r235', 'idx', 'https://127.0.0.1/', '0', null);
INSERT INTO `cmf_reactapp` VALUES ('6', '1', '2', 'getlistdata', '获取数据列表', 'xx:admin,yy:wywweeq', '', 'uid', 'http://127.0.0.1/alldata', '1', null);
INSERT INTO `cmf_reactapp` VALUES ('7', '3', '2', 'getcitydata', '城市', '', '', '', 'http://localhost/a.json', '1', null);
...
CREATE TABLE `cmf_reactfilelist` (
  ...
  `directoryname` varchar(255) DEFAULT NULL COMMENT '所在目录',
...
-- ----------------------------
INSERT INTO `cmf_reactfilelist` VALUES ('1', '2', 'wenming', 'adwords', '广告管理', '.vue');
INSERT INTO `cmf_reactfilelist` VALUES ('2', '1', 'wenming', 'notice', '公告管理', '.vue');
INSERT INTO `cmf_reactfilelist` VALUES ('3', '1', 'wenming', 'answers', '问题列表', '.vue');
INSERT INTO `cmf_reactfilelist` VALUES ('4', '1', 'wenming', 'userlist', '用户列表', '.js');
INSERT INTO `cmf_reactfilelist` VALUES ('5', '2', 'wenming', 'system', '系统设置', '.vue');
INSERT INTO `cmf_reactfilelist` VALUES ('7', '2', 'test', 'piclist', '图片列表', '.vue');
INSERT INTO `cmf_reactfilelist` VALUES ('9', '2', 'test', 'member', '会员管理', '.vue');
INSERT INTO `cmf_reactfilelist` VALUES ('10', '2', 'test', 'wenming', '文明网', '.vue');
INSERT INTO `cmf_reactfilelist` VALUES ('11', '2', 'music', 'index2', '音乐', '.vue');
...
-- ----------------------------
-- Table structure for cmf_reactgroup
-- ----------------------------
DROP TABLE IF EXISTS `cmf_reactgroup`;
CREATE TABLE `cmf_reactgroup` (
  `id` int(255) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of cmf_reactgroup
-- ----------------------------
INSERT INTO `cmf_reactgroup` VALUES ('1', '云耕农夫');
INSERT INTO `cmf_reactgroup` VALUES ('2', '智媒体');
...
-- ----------------------------
INSERT INTO `cmf_reactvue` VALUES ('5', '2', 'picurl', '图片', '1', '1', '1', '1', '200');
INSERT INTO `cmf_reactvue` VALUES ('6', '2', 'content', '内容', '0', '0', '8788778', '0', '886');
...
-- Records of cmf_user
-- ----------------------------
INSERT INTO `cmf_user` VALUES ('1', '1', '0', '0', '1524575820', '1', '1', '0.00', '1523683335', '1', 'admin', '###842861c912b7401e3fa518ca55a72566', 'admin', 'songxian@163.com', '', '', '', '0.0.0.0', '', '', null);
